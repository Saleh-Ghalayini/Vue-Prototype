    ...
    <div class="w-full lg:w-1/2 flex flex-col relative bg-primary p-8">
      ...
      <div class="max-w-md mx-auto my-auto w-full flex flex-col gap-6">
        ...
        <div class="text-sm text-white/80">
          <p>Password must be at least 6 characters and include:</p>
      ...
      <div class="absolute bottom-8 left-0 right-0 text-center">
        <a href="#" class="text-white hover:underline hover:text-accent/90 transition-all duration-200">Trouble signing up?</a>
      </div>
      <!-- End of Footer -->

    </div>
    <!-- End of Left Column - Registration Form -->
     
    <!-- Right Column - Illustration -->
    <div class="hidden lg:flex lg:w-1/2 bg-white justify-center items-center p-8">
      <img src="../assets/images/login-illustration.png" alt="Registration Illustration" class="max-w-full max-h-[80vh] object-contain" />
    </div>
  </div>
</template>
